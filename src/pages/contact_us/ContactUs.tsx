...
function ContactUs() {
  return (
    <div>
      <Navbar />
      <div className="max-w-[85rem] px-4 sm:px-6 pt-24 lg:pt-28 pb-12 lg:px-8 mx-auto ">
                ...
                <div className="grid gap-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="py-3 px-4 block w-full h-44 border-2 border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500"
                      placeholder="Details"
                    />
                  </div>
                </div>
            ...
            <div className="divide-y divide-gray-200">
              ...
              <div className=" flex gap-x-7 py-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Check out our privacy policy guide.
                  </p>
                  <Link
                    className="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200"
                    to="/privacy-policy"
