...
import IChat, { IChatMessage } from "../../models/ChatModels";
...
export const ChatSupport = () => {
  ...
  function handleMessageForm(e: ChangeEvent<HTMLInputElement>) {
    setChatMessage({
      ...chatMessage,
  ...
  function handleSendChatMessage() {
    socket.emit("chat", chatMessage, (cb: IApiResponse<IChat>) => {
      setMessages([...messages, cb.data]);
    });
    setChatMessage({ message: "", sender: userId, receiver: "321" });
  }

  useEffect(() => {
    socket = Io("https://directwayz-api.fly.dev", {
  ...
  }, ["https://directwayz-api.fly.dev"]);
  return (
    <div>
      <Navbar />
      <div className="pt-24 flex h-screen antialiased text-gray-800">
          ...
          <div className="flex flex-col flex-auto h-full p-6">
            <div className="flex flex-col flex-auto flex-shrink-0 rounded-2xl bg-gray-100 h-full p-4">
              ...
              <div className="flex flex-row items-center h-16 rounded-xl bg-white w-full px-4">
                ...
                <div className="ml-4">
                  <button
                    disabled={!Boolean(chatMessage.message)}
