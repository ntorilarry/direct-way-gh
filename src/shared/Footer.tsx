...
export default function Footer() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const scrollThreshold = 1000; // Adjust this threshold value as needed
  ...
  return (
    <div className="bg-[#4187ED]">
        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-4 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
              <a href="/">
                {" "}
                <img className="w-auto h-16" src={Logo2} alt="" />
              </a>
              ...
              <ul className="flex items-center space-x-3 mt-9">
                <li>
                  <a
                    href="#"
                    title=""
                    className="flex items-center justify-center text-[#4187ED] transition-all duration-200 bg-white rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600"
                  >
                    <svg
                      className="w-4 h-4"
              ...
              <ul className="mt-6 space-y-4">
                <li>
                  <Link
                    to="/jobs"
                    title=""
                    className="flex text-sm text-white transition-all duration-200 hover:text-blue-600"
                  >
                    {" "}
                    All Jobs
                  </Link>
          ...
          <p className="text-sm pb-6 text-center text-white">
            © Copyright 2023, All Rights Reserved by Directwayz GH
          </p>
        </div>
      </section>
      ...
      <button
        ...
        } fixed z-90 bottom-10 right-8 bg-[#4187ED] p-1 rounded-full drop-shadow-lg flex justify-center items-center text-white text-3xl hover:scale-125 transition duration-300`}
      >
        <AiOutlineArrowUp />
      </button>
    </div>
