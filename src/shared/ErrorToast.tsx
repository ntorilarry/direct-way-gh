...
function ErrorToast({ isOpen, message, onRequestClose }) {
      ...
      <div>
        <Transition appear show={isOpen} as={Fragment}>
          <Dialog as="div" onClose={closeEditModal}>
            ...
            <div className="fixed z-50 inset-0 flex min-h-screen items-center justify-center overflow-hidden px-4  text-center sm:block sm:p-0">
              <Transition.Child
                as={Fragment}
                enter="ease-out duration-300"
